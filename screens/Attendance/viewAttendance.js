         ...
         >
            ...
            >
               ...
               <View style={{ marginTop: 30 }}>
                  ...
                  >
                     <Text style={{ width: "40%" }}>Santosh</Text>
                     <Text style={{ width: "30%" }}>10A</Text>
                     <Text style={{ width: "30%", color: "#ff4646" }}>
                        Absent
                     </Text>
                  </View>
                  <View
                  ...
                  >
                     <Text style={{ width: "40%" }}>Ramesh</Text>
                     <Text style={{ width: "30%" }}>10A</Text>
                     <Text style={{ width: "30%", color: "#008d13" }}>
                        Present
                     </Text>
                  </View>
               </View>
